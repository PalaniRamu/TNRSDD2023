# -*- coding: utf-8 -*-
"""TNRSDD2023_YOLOV7_Custom Data

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XfqjGXLNSaQP7bawBIQOXKUy6Cfrqd97
...
#step 4: information about process
"""
...
# Commented out IPython magic to ensure Python compatibility.
# %cd /content/yolov7
!python train.py  --weights /content/yolov7/yolov7_training.pt --data "data/custom.yaml" --workers 4 --batch-size 8 --img 416 --cfg cfg/training/yolov7.yaml --name TNRSDD2023 --hyp data/hyp.scratch.p5.yaml --epochs 50
...
# %cd /content/yolov7
!python train.py --batch 16 --epochs 55 --data /content/yolov7/custom.yaml --weights  --device 0
...
# Run evaluation
# %cd /content/yolov7
!python detect.py --weights /content/yolov7/runs/train/TNRSDD20234/weights/best.pt --conf 0.1 --source /content/yolov7/dataset/video/testvideo_3.mp4
